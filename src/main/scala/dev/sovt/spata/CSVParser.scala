...
import dev.sovt.spata.CSVParser.Callback
import dev.sovt.spata.error.CSVException
import dev.sovt.spata.error.ParsingErrorCode
import dev.sovt.spata.error.StructureException
import dev.sovt.spata.parser.CharParser
import dev.sovt.spata.parser.FieldParser
import dev.sovt.spata.parser.RecordParser
import dev.sovt.spata.parser.RecordParser.RecordResult
